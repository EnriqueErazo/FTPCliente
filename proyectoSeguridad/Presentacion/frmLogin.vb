...
Public Class frmLogin
	...
	Dim _usuario As String : Dim _valor2 As String : Dim _valor3 As String : Dim ip As String
	...
	Private Sub btnIngresar_Click(sender As Object, e As EventArgs) Handles btnIngresar.Click
		...
		ip = txtIP1.Text & lblP1.Text & txtIP2.Text & lblP2.Text & txtIP3.Text & lblP3.Text & txtIP4.Text
		...
		WinSockCliente.IPDelHost = ip : WinSockCliente.PuertoDelHost = txtPuerto.Text : WinSockCliente.Conectar()
		'MsgBox("Conexion exitosa IP: " & ip & " Puerto: " & txtPuerto.Text)
		'hash = Encrip.Md5Encryta(XML.cadena(txtUsuario.Text, "123"))
		'txtPuerto.Enabled = False
		Try
			Using md5Hash As MD5 = MD5.Create()
				WinSockCliente.EnviarDatos(Encrip.EncryptString(ManejoXml.SerialiazarXml(txtUsuario.Text, Encrip.Md5Encryta(md5Hash, txtPassword.Text), "", "Login")))
	...
	Public Function DLogin(ByVal str As String)
		...
		End Using
		_usuario = items1.valor1 : _valor2 = items1.valor2 : _valor3 = items1.valor3 : _respuesta = items1.Funcion
		Return _respuesta
	End Function
End Class